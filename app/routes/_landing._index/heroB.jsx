...
export default function Hero({ textHeading, textSubHeading }) {
   return (
      <section className="size-full">
         <WavyBackground className="mx-auto w-full pb-40">
            <h1 className="inter-var text-center text-2xl font-bold text-white md:text-4xl lg:text-7xl">{textHeading}</h1>
            <p className="inter-var mt-4 text-center text-base font-normal text-white md:text-lg">{textSubHeading}</p>
         </WavyBackground>
      </section>
   )
}
