...
export default async function handleRequest(request, responseStatusCode, responseHeaders, remixContext, loadContext) {
   ...
   responseHeaders.set(
      ...
      `script-src 'nonce-${cspNonce}' 'strict-dynamic'; base-uri 'none'; frame-ancestors 'none'; object-src 'none'; connect-src 'self' https://*.ingest.us.sentry.io ${loadContext.cloudflare.env.SUPABASE_URL} ${loadContext.cloudflare.env.DEVELOPMENT_TUNNEL} https://calendar.google.com https://challenges.cloudflare.com/ ; form-action 'self'; upgrade-insecure-requests; img-src 'self' data: ; font-src 'self' https://fonts.gstatic.com; style-src 'self' 'nonce-${cspNonce}' https://fonts.googleapis.com ; style-src-attr 'self' 'unsafe-inline'; default-src 'none'; frame-src https://calendar.google.com https://challenges.cloudflare.com; report-uri https://o4505840240820224.ingest.sentry.io/api/4506978046705664/security/?sentry_key=3c30760472749bd3dd6c98bfe3785b07;`,
   )
